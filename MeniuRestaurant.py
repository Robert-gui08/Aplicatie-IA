...
class RestaurantApp:
    def __init__(self, root):
        ...
        self.add_item_button = tk.Button(root, text="Adaugă Produs în Meniu", font=("Arial", 14), bg="#FF9800",
                                         fg="white",
                                         command=self.add_item_to_menu)
        self.add_item_button.pack(pady=10)

        self.view_order_button = tk.Button(root, text="Vizualizează Comanda", font=("Arial", 14), bg="#2196F3",
                                           fg="white",
    ...
    def toggle_items(self, category):
        # Dacă există o categorie deschisă, o , o \u00enchidem
    ...
    def show_items(self, category):
        ...
        for item, price in menu[category].items():
            button = tk.Button(self.items_frame, text=f"{item} - {price} RON", font=("Arial", 12), bg="#2196F3",
                               fg="white",
    ...
    def reset_order(self):
        self.selected_items = []
        self.total_label.config(text="Total: 0 RON")  # Resetează eticheta pentru total
    ...
    def add_item_to_menu(self):
        ...
        add_button = tk.Button(add_window, text="Adaugă Produs", font=("Arial", 12), bg="#4CAF50", fg="white",
                               command=add_product)
